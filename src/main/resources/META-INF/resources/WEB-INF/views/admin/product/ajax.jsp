...
<div class="page-heading">
    ...
    <button class="btn btn-primary" id="add-product-button" type="button">
        + Thêm sản phẩm
    </button>
</div>
...
<form class="search-box" id="product-search-form">
    ...
    <button class="btn btn-light" id="product-clear-button" type="button">
        Xóa lọc
    </button>
</form>
    ...
    <section
        ...
        <form id="product-form" enctype="multipart/form-data">
            ...
            <div class="form-actions">
                ...
                <button class="btn btn-light" id="product-cancel-button" type="button">
                    Hủy
                </button>
            </div>
        </form>
